    ...
    return (
          <DialogContent className="sm:max-w-[425px] bg-black">
            <DialogHeader>
              ...
              <DialogDescription>
                To get instant notifications of insider trades of hedge funds and politicians
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
                <div className="mx-auto">
                  <button onClick={() => handleGoogleLogin()} className="flex w-56 items-center bg-white dark:bg-gray-900 border rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200">
